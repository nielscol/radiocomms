...
from lib.transforms import butter_lpf, cheby2_lpf, fir_filter, add_noise, sum_signals, filter_and_downsample, gaussian_fade, fft_resample
...
if __name__ == "__main__":
    ...
    msk_interferer_rf = upconvert_baseband(INTERFERER_CARRIER, msk_i, msk_q)
    ...
    # Simulate fading
    if FADING:
        rf = gaussian_fade(rf, f = 1000) # this is really arbitrary...
    ...
    rx_i, rx_q = downconvert_rf(CARRIER, rf)
